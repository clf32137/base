#This code should come before the imports to make sure we can import from parent directories.
...
#[1] https://github.com/msushkov/cs224d-hw2/blob/master/part2-RNNLM.ipynb
#[2] https://github.com/dengfy/cs224d/blob/master/assignment2/rnnlm.py
